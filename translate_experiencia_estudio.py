...
files = [
    ('src/components/admin/ExperienciaForm.vue', 'experiencia_form'),
    ('src/views/admin/ExperienciasAdmin.vue', 'experiencias_admin'),
    ('src/components/admin/EstudioForm.vue', 'estudio_form'),
    ('src/views/admin/EstudiosAdmin.vue', 'estudios_admin')
]
