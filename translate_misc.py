...
files = [
    ...
    ('src/views/admin/AparienciaAdmin.vue', 'apariencia_admin'),
    ('src/views/admin/FrasesAdmin.vue', 'frases_admin'),
    ('src/components/admin/FraseForm.vue', 'frase_form'),
    ('src/views/private/NetworkHub.vue', 'network_hub'),
    ('src/views/private/HomeFeed.vue', 'home_feed')
]
...
for filepath, prefix in files:
    ...
    if len(extracted) > 0:
        ...
        for key, text in extracted.items():
            ...
            print(f"Translated in {filepath}: {text} -> {en_text}")
