...
files = [
    ('src/components/admin/ReconocimientoForm.vue', 'reconocimiento_form'),
    ('src/views/admin/ReconocimientosAdmin.vue', 'reconocimientos_admin'),
    ('src/components/admin/HabilitacionForm.vue', 'habilitacion_form'),
    ('src/views/admin/HabilitacionesAdmin.vue', 'habilitaciones_admin')
]
